...
function connect2MySQL(){
    try{
        $pdo = new PDO('mysql:host=localhost;dbname=Challenge_db;charset=utf8','murakami','runrun22');
...
function update_profile($id,$name,$birthday,$tell,$type,$comment,$date){
    //db接続を確立
